...
/**
 * All tests in here use the simple memory cache, i.e., one which immediately loads cached values
 */
test("Cache works with simple client and cacheFirst strategy", async t => {
...
test("Cache works with simple client and no specified table", async t => {
    const expectedResult = {result: "cacheTest1Result"};
    const expectedStringified = JSON.stringify(expectedResult);
    const fetch = mockFetch({
        result: expectedStringified,
...
test("Cache works with simple client and race strategy", async t => {
...
test("Stale cache result is returned in no-update race mode", async t => {
...
test("Cached result gets updated when fresh data is available in update race mode", async t => {
...
test("Fresh result is returned in fetchFirst mode", async t => {
    const expectedResult1 = {result: "cacheTestResultStale1"};
    const expectedResult2 = {result: "cacheTestResultFresh1"};
    const expectedStringified1 = JSON.stringify(expectedResult1);
    const expectedFinalStringified = JSON.stringify(expectedResult2);
...
test("Return headers works with caching client and fetchFirst", async t => {
    const header = "X-Test";
    ...
    const client = await createFetchClient({fetch: fetch, cache: {id: "memory", maxItems: 5}});
    const cacheRequestConfig = {useCache: {mode: "fetchFirst", table: "Test", key: "a"}};
...
test("Return headers works with caching client and cacheFirst", async t => {
    const header = "X-Test";
    const expectedHeader = "expectedTestHeader3!";
    const expectedResult = {result: "testResultAlongHeader3"};
    const expectedResultStr = JSON.stringify(expectedResult);
...
test("Return headers works with caching client and race", async t => {
    const header = "X-Test";
    const expectedHeader = "expectedTestHeader3!";
    const expectedResult = {result: "testResultAlongHeader3"};
    const expectedResultStr = JSON.stringify(expectedResult);
...
test("Return headers works with caching client and race with actual update", async t => {
    const header = "X-Test";
...
test("Cache control no-store directive is respected", async t => {
    const expectedResult1 = {result: "cacheTestResultStale1"};
    const expectedResult2 = {result: "cacheTestResultFresh1"};
    const expectedStringified1 = JSON.stringify(expectedResult1);
    const expectedFinalStringified = JSON.stringify(expectedResult2);
...
test("Cache control no-cache directive is respected", async t => {
    const expectedResult1 = {result: "cacheTestResultStale1"};
    const expectedResult2 = {result: "cacheTestResultFresh1"};
    const expectedStringified1 = JSON.stringify(expectedResult1);
    const expectedFinalStringified = JSON.stringify(expectedResult2);
...
test("Cache control max-age > 0 directive is respected", async t => {
    const expectedResult1 = {result: "cacheTestResultStale1"};
    const expectedResult2 = {result: "cacheTestResultFresh1"};
    const expectedStringified1 = JSON.stringify(expectedResult1);
    const expectedFinalStringified = JSON.stringify(expectedResult2);
...
test("Cache control stale-if-error directive is respected1", async t => {
    const expectedResult1 = {result: "cacheTestResultStale1"};
    const expectedResult2 = {result: "cacheTestResultFresh1"};
    const expectedStringified1 = JSON.stringify(expectedResult1);
    const expectedFinalStringified = JSON.stringify(expectedResult2);
...
test("Simple cache works with multiple tables", async t => {
    ...
    const client = await createFetchClient({
        cache: {id: "memory", dbName: "TestMultiple", maxItems: 5},
        fetch: fetch
    });
...
test("cloneItems works with simple cache", async t => {
    ...
    const client = await createFetchClient({
        cache: {id: "memory", maxItems: 5, cloneItems: true},
        fetch: fetch
    });
    const cacheRequestConfig = {useCache: {mode: "cacheControl", table: "Test", key: "a1", defaultCacheControl: {maxAge: true}}};
    const result1 = await client.fetchJson("", cacheRequestConfig);
